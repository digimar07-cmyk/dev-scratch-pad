...
class LaserflixMainWindow:
    ...
    def create_ui(self):
        ...
        # Bind do scroll no canvas E propagado recursivamente para todos widgets filhos
        def _mw(e):
    ...
    def _bind_cards_scroll(self, widget):
        """Propaga bind do scroll recursivamente para todos os widgets dos cards."""
        def _scroll(e):
            self.content_canvas.yview_scroll(int(-1*(e.delta/SCROLL_SPEED)), "units")
        widget.bind("<MouseWheel>", _scroll)
        for child in widget.winfo_children():
            self._bind_cards_scroll(child)
    ...
    def display_projects(self):
        ...
        # Aplica scroll recursivo nos cards recém-criados
        self._bind_cards_scroll(self.scrollable_frame)
    ...
    # [RESTO DO CÓDIGO PERMANECE INALTERADO - OMITIDO PARA BREVIDADE]