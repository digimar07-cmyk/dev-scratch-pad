...
class LaserflixMainWindow:
    ...
    def open_project_modal(self, project_path):
        # Implementação completa do modal... (continua igual ao commit 20a7040e)
        pass
    ...
    def open_edit_mode(self, parent_modal, project_path, data):
        # Implementação completa... (continua igual ao commit 20a7040e)
        pass

    # Métodos auxiliares de edição...
    def _add_tag_to_listbox(self, listbox): pass
    def _remove_tag_from_listbox(self, listbox): pass
    def _save_edit_modal(self, modal, project_path, categories_text, tags_listbox): pass

    # =========================================================================
    # IA: ANÁLISE
    # =========================================================================

    def show_progress_ui(self): pass
    def hide_progress_ui(self): pass
    def update_progress(self, current, total, message=""): pass
    def analyze_single_project(self, project_path): pass
    def analyze_only_new(self): pass
    def reanalyze_all(self): pass

    # =========================================================================
    # DESCRIÇÕES IA
    # =========================================================================

    def _batch_generate_descriptions(self, targets): pass
    def generate_descriptions_for_new(self): pass
    def generate_descriptions_for_all(self): pass

    # =========================================================================
    # UTILITÁRIOS
    # =========================================================================

    def open_categories_picker(self): pass
    def open_model_settings(self): pass
    def export_database(self): pass
    def import_database(self): pass
    def manual_backup(self): pass
    def darken_color(self, hex_color): pass
